...
#enumerate function: it take only one argument,it does not work on multiple argument
# 6)
id=[11,22,33,44]
name=['amit','raj','bipin','pankaj']
salary=[6000, 6000, 30000, 12500]
...
print()
print()
for x in zip(range(len(combine)),(combine)):
    print(x)
print()
print()
...
print()
print()
for x,item in zip(range(len(combine)),(combine)):
    print(x)
    print(item)
print()
print()
...
print()
print()
for x,item in enumerate(combine):
    print(x,item)
print()
